/**
    ...
    @brief
        Defines for the SDM35541 Example programs.  Commonly used constants
        for the example programs included with the software package.


    $Id: SDM35541_examples.h 114740 2018-07-12 14:41:17Z prucz $
*/
...
#ifndef __SDM35541_EXAMPLES_H__
#define __SDM35541_EXAMPLES_H__

 /**
  * @defgroup SDM35541_Example_Constants SDM35541 Example Programs Constants
  * @{
  */
