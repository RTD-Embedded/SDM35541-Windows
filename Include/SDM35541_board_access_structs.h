/**
    ...
    $Id: SDM35541_board_access_structs.h 80523 2014-07-17 18:38:59Z rgroner $
*/
...
#ifndef _SDM35541_BOARD_ACCESS_STRUCTS__H_
#define _SDM35541_BOARD_ACCESS_STRUCTS__H_


/**
 * @defgroup SDM35541_PCI_Region_Structures SDM35541 PCI Region Structures
 * @{
 */
...
enum SDM35541_pci_region_access_size {

	/**
	 * 8-bit access
	 */

	SDM35541_PCI_REGION_ACCESS_8 = 0,

	/**
	 * 16-bit access
	 */

	SDM35541_PCI_REGION_ACCESS_16,

	/**
	 * 32-bit access
	 */

	SDM35541_PCI_REGION_ACCESS_32,
 ...
 */
enum SDM35541_DMA_FUNCTIONS {

	/**
	 * Initialize the DMA buffers
	 */
	SDM35541_DMA_INITIALIZE,
...
struct SDM35541_pci_access_request {

	/**
	 * Size of access in bits
	 */

	enum SDM35541_pci_region_access_size size;

	/**
	 * The PCI region to access
	 */

	enum SDM35541_pci_region_num region;
...
struct SDM35541_ioctl_region_readwrite {

	/**
	 * PCI region access request
	 */

	struct SDM35541_pci_access_request access;
};
...
struct SDM35541_ioctl_region_modify {
...
struct SDM35541_ioctl_interrupt_info_request {
 ...
 */
struct SDM35541_ioctl_dma {

	/**
	 * Requested DMA function to perform.
	 */
	enum SDM35541_DMA_FUNCTIONS function;
	 ...
	 */
	struct SDM35541_pci_access_request pci;
...
union SDM35541_ioctl_argument {

	/**
	 * PCI region read and write
	 */

	struct SDM35541_ioctl_region_readwrite readwrite;

	/**
	 * PCI region read/modify/write
	 */

	struct SDM35541_ioctl_region_modify modify;

	/**
	 * Interrupt request structure
	 */

	struct SDM35541_ioctl_interrupt_info_request interrupt;
	/**
	 * DMA Configuration and Control
	 */

	struct SDM35541_ioctl_dma dma;
